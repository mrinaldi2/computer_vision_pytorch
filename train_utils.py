...
def load_data(data_dir = './flowers/'):
    ...
    non_trained_transforms = transforms.Compose([transforms.Resize(255), 
    ...
    test_data = datasets.ImageFolder(test_dir, transform=non_trained_transforms)
    validate_data = datasets.ImageFolder(valid_dir, transform=non_trained_transforms)
...
def create_model(model_name='vgg19', hidden_input=1024, 
                 learning_rate=0.001, mode='cuda'):
    ...
    if model_name == 'vgg19':
        ...
        print("Im sorry but {} is not a valid model. Did you mean vgg19, densenet121, resnet152, or alexnet?".format(model_name))
